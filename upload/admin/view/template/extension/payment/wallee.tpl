		...
		<form action="<?php echo $action ?>" method="post"
		  ...
		  <?php foreach ($shops as $store) { ?>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						<i class="fa fa-pencil"></i> <?php echo htmlspecialchars($text_information); ?></h3>
				</div>
				<div class="panel-body">
					<fieldset>
						<legend><?php echo htmlspecialchars($title_modifications) ?></legend>
					...
					<fieldset>
						<legend><?php echo htmlspecialchars($title_migration) ?></legend>
	
						<div class="form-group">
							<label class="col-sm-2 control-label"><?php echo htmlspecialchars($entry_migration_name) ?></label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"><?php echo htmlspecialchars($entry_migration_version) ?></label>
							<div class="col-sm-10">
